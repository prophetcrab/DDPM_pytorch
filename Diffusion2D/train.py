...
from Utils.dataloader import DiffusionDataset, Diffusion_dataset_collate
...
if __name__ == "__main__":
    ...
    # ---------------------------------------------------------------------#
    diffusion_model_path = r"D:\PythonProject2\DDPM_pytorch\Diffusion2D\logs\diffusion_model_last_epoch_weights.pth"
    # ---------------------------------------------------------------------#
